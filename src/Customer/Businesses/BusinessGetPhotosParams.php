 ...
 *
 * @see Eat518\Services\Customer\BusinessesService::getPhotos()
 *
 * @phpstan-type BusinessGetPhotosParamsShape = array{
 *   page?: int|null, perPage?: int|null
 * }
 */
final class BusinessGetPhotosParams implements BaseModel
{
    /** @use SdkModel<BusinessGetPhotosParamsShape> */
    use SdkModel;
    use SdkParams;
