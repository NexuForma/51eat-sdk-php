 ...
 *
 * @see Eat518\Services\Customer\Businesses\MenusService::retrieve()
 *
 * @phpstan-type MenuRetrieveParamsShape = array{
 *   page?: int|null, perPage?: int|null
 * }
 */
final class MenuRetrieveParams implements BaseModel
{
    /** @use SdkModel<MenuRetrieveParamsShape> */
    use SdkModel;
    use SdkParams;
