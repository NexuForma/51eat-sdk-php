 ...
 *
 * @see Eat518\Services\Customer\TicketsService::list()
 *
 * @phpstan-type TicketListParamsShape = array{page?: int|null, perPage?: int|null}
 */
final class TicketListParams implements BaseModel
{
    /** @use SdkModel<TicketListParamsShape> */
    use SdkModel;
    use SdkParams;
