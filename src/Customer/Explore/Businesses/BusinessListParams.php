...
namespace Eat518\Customer\Explore\Businesses;
 ...
 *
 * @see Eat518\Services\Customer\Explore\BusinessesService::list()
 *
 * @phpstan-type BusinessListParamsShape = array{
 *   bounds: string, zoomLevel?: int|null
 * }
 */
final class BusinessListParams implements BaseModel
{
    /** @use SdkModel<BusinessListParamsShape> */
    use SdkModel;
    use SdkParams;
    ...
    /**
     * `new BusinessListParams()` is missing required properties by the API.
     *
     * To enforce required parameters use
     * ```
     * BusinessListParams::with(bounds: ...)
     * ```
     *
     * Otherwise ensure the following setters are called
     *
     * ```
     * (new BusinessListParams)->withBounds(...)
     * ```
     */
