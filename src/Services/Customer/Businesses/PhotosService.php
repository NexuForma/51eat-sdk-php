...
use Eat518\ServiceContracts\Customer\Businesses\PhotosContract;

/**
 * @phpstan-import-type RequestOpts from \Eat518\RequestOptions
 */
final class PhotosService implements PhotosContract
{
    /**
     * @api
     */
    public PhotosRawService $raw;
    ...
    {
        $this->raw = new PhotosRawService($client);
    }
